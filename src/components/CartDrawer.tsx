              ...
              {cart.map((item) => (
                ...
                >
                  ...
                  <div className="w-14 h-14 bg-white rounded-xl border border-gray-100 p-1 flex items-center justify-center shrink-0">
                    <ProductImage productId={item.product.id} alt={item.product.name} className="w-full h-full object-contain" src={item.product.image} fallbackSvg={item.product.fallbackSvg} />
                  </div>
